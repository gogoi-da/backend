...
export class GetTestQuestionResponse extends MessageResponse {
  @ApiProperty({
    description: 'Test question details',
    type: TestQuestionDetailData,
  })
  data: TestQuestionDetailData;
}
